...
public class Login_Repo extends AppModelBase {		private NoqodiPage_Login NoqodiPage_Login;
	
	public Login_Repo(TestObject contextTestObject) throws GeneralLeanFtException
	{
		setName("Login_Repo");
				NoqodiPage_Login = new NoqodiPage_Login(contextTestObject, this);
		rebuildDescriptions();
	}	

			public NoqodiPage_Login NoqodiPage_Login() { return NoqodiPage_Login; }

		public class NoqodiPage_Login extends PageNodeBase
	{
	...
	private LoginButton LoginButton;
						public NoqodiPage_Login(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
	...
	public class LoginButton extends ButtonNodeBase
	{
		...
		protected com.hp.lft.sdk.web.ButtonDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.web.ButtonDescription.Builder().buttonType("button").name("                                Login                            ").tagName("BUTTON").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
